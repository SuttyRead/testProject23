...
public class ArrayCollectionTest {
    ...
    public void before() throws Exception {
        arrayCollection = new LoggingArrayCollectionImpl<>();
    }
    ...
    public void testSetGetArray() {
        ...
        assertNotNull("getArray returned null after setArray", arrayCollection
            .getArray());
    ...
    public void testAddNull() {
        ...
        assertNotNull("getArray returned null after add", arrayCollection
            .getArray());
        assertEquals("length of array should be 1", 1, arrayCollection
            .getArray().length);
    ...
    public void testAddAll() {
        ...
        assertNotNull("getArray returned null after addAll", arrayCollection
            .getArray());
        assertArrayEquals("checking for equals of derived and initial arrays",
            doubleArray, arrayCollection.getArray());
    ...
    public void testClear() {
        ...
        assertNotNull("in clear should return empty array", arrayCollection
            .getArray());
        assertEquals("should be empty after clear", 0, arrayCollection
            .getArray().length);
    }
    ...
    public void testContainsNull() {
        ...
        assertEquals("size should be 1 after 1 add", 1, arrayCollection
            .getArray().length);
    }
    ...
    public void testContainsAll() {
        arrayCollection.addAll(Arrays.asList(doubleArray));
        assertTrue("wrong containsAll", arrayCollection.containsAll(Arrays
            .asList(doubleArray)));
        assertEquals("wrong size", doubleArray.length, arrayCollection
            .getArray().length);
    ...
    public void testRemove() {
        arrayCollection.add(doubleArray[0]);
        assertTrue("should return true on remove", arrayCollection
            .remove(doubleArray[0]));
        assertFalse("contains removed element", Arrays.asList(
            arrayCollection.getArray()).contains(doubleArray[0]));

        arrayCollection.add(doubleArray[0]);
        arrayCollection.add(doubleArray[0]);
        assertFalse("sshould return false, if collection not changed",
            arrayCollection.remove(doubleArray[1]));
        assertEquals("size should not be changed", 2, arrayCollection
            .getArray().length);
        assertTrue("should return true on remove", arrayCollection
            .remove(doubleArray[0]));
        assertTrue("remove should remove only one elements", Arrays.asList(
            arrayCollection.getArray()).contains(doubleArray[0]));
    ...
    public void testRemoveAll() {
        ...
        assertTrue("should return true if coll changed", arrayCollection
            .removeAll(Arrays.asList(doubleArray)));
        assertFalse("should be not empty", arrayCollection.isEmpty());
        assertTrue("should contain one elem", Arrays.asList(
            arrayCollection.getArray()).contains(-doubleArray[0]));
    ...
    public void testRetainAll() {
        ...
        assertTrue("should return true, if collection changed", arrayCollection
            .retainAll(Arrays.asList(doubleArray)));
        assertFalse("should contain only ratain elem", arrayCollection
            .contains(-doubleArray[0]));
        assertTrue("should contain only ratain elem", Arrays.asList(
            arrayCollection.getArray()).contains(doubleArray[0]));
        assertTrue("should contain only ratain elem", Arrays.asList(
            arrayCollection.getArray()).contains(doubleArray[2]));
    }
    ...
    public void testIterator() {
        assertTrue("if iterator() returns right class", arrayCollection
